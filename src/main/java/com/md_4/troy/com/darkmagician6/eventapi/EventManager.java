...
package com.md_4.troy.com.darkmagician6.eventapi;

import com.ibm.icu.text.PluralRules;
import com.md_4.troy.com.darkmagician6.eventapi.events.Event;
import com.md_4.troy.com.darkmagician6.eventapi.events.EventStoppable;
import com.md_4.troy.com.darkmagician6.eventapi.types.Priority;
...
public final class EventManager
{
    ...
    private static void register(final Method method, final Object object) {
        ...
        if (EventManager.REGISTRY_MAP.containsKey(indexClass)) {
            ...
            EventManager.REGISTRY_MAP.put(indexClass, new CopyOnWriteArrayList<MethodData>(Collections.singleton(data)) {
                ...
                private void add(PluralRules.Operand e) {
                }
            });
        }
    }
