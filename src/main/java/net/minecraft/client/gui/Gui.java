...
public class Gui
{
    ...
    public static void drawRectIGM(int left, int top, int right, int bottom, final int Color1, final int Color2, final int Color3) {
        if (left < right) {
            final int i = left;
            left = right;
            right = i;
        ...
        GlStateManager.disableTexture2D();
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        GlStateManager.color((float)Color1, (float)Color2, (float)Color3);
        worldrenderer.begin(7, DefaultVertexFormats.POSITION);
