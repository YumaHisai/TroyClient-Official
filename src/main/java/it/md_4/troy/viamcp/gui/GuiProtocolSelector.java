package it.md_4.troy.viamcp.gui;
...
import it.md_4.troy.viamcp.protocols.ProtocolCollection;
...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.BOLD + "Version Library", this.width / 4, 5, 16777215);
