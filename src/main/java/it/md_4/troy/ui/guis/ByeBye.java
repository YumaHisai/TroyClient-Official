...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 168, I18n.format("Ok", new Object[0])));
    }
    ...
    public void drawScreen(int n, int n2, float f) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("\u00a7cAnti-Piracy > You are using a non-purchased version", new Object[0]), this.width / 2, 100, 0xFFFFFF);
