...
extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 168, I18n.format("GoodBye", new Object[0])));
    }
    ...
    public void drawScreen(int n, int n2, float f) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("\u00a7cBan-System > You are been banned from TroyClient", new Object[0]), this.width / 2, 100, 0xFFFFFF);
