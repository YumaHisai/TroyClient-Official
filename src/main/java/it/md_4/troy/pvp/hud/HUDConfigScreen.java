...
public class HUDConfigScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for(IRenderer renderer : renderers.keySet()) {
            ...
            this.drawHollowRect(pos.getAbsoluteX(), pos.getAbsoluteY(), renderer.getWeight(), renderer.getHeight(), 0xFF00FFFF);
        }
        this.zLevel = zBackup;
    }
    ...
    private void adjustBounds(IRenderer renderer, ScreenPosition pos) {
        ...
        int absoluteX = Math.max(0, Math.min(pos.getAbsoluteX(), Math.max(screenWidth - renderer.getWeight(), 0)));
